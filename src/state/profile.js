...
// [stated] 영문 8글자 / 한글 5글자가 최대.
// 한글이 훨씬 넓어서 글자 수로만 세면 이름 칸이 넘친다.
// **폭 예산**으로 센다 — 영문·숫자 1칸, 한글·한자·가나 1.6칸, 예산 8칸
export const NICK_BUDGET = 8;
export const NICK_MAX = 8;            // 영문 기준 최대 글자 수 (안내용)
export const NICK_MAX_KO = 5;         // 한글 기준
